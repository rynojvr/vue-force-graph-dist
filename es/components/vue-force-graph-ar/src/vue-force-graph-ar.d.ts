...
export declare const vueForceGraphARProps: {
    ...
    markerAttrs: ObjectConstructor;
    yOffset: NumberConstructor;
    glScale: NumberConstructor;
};
export declare type VueForceGraphARProps = ExtractPropTypes<typeof vueForceGraphARProps>;
