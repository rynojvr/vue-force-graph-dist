...
export declare const vueForceGraphVRProps: {
    ...
    nodeDesc: (FunctionConstructor | StringConstructor)[];
    linkDesc: (FunctionConstructor | StringConstructor)[];
};
export declare type VueForceGraphVRProps = ExtractPropTypes<typeof vueForceGraphVRProps>;
