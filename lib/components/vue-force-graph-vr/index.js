...
var fromKampsule = require('vue-force-graph/lib/utils/from-kapsule');
var ForceGraphVR = require('3d-force-graph-vr');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var fromKampsule__default = /*#__PURE__*/_interopDefaultLegacy(fromKampsule);
var ForceGraphVR__default = /*#__PURE__*/_interopDefaultLegacy(ForceGraphVR);

const vueForceGraphVRProps = {
    width: Number,
    height: Number,
    graphData: {
        type: Object,
...
var script = fromKampsule__default["default"](ForceGraphVR__default["default"], {
    methodNames: [
        "getGraphBbox",
        "emitParticle",
        "d3Force",
    ...
    name: "VueForceGraphVR",
    props: vueForceGraphVRProps,
});

script.__file = "packages/components/vue-force-graph-vr/src/vue-force-graph-vr.vue";

const VueForceGraphVR = withInstall.withInstall(script);

exports.VueForceGraphVR = VueForceGraphVR;
exports["default"] = VueForceGraphVR;
